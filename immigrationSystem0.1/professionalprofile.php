    ...
    if(isset($_POST['employern']))
        {
            ...
            $messages[] = "<li>employer name is valid</li>";
         }else{
                 $errors[] = "<li>employer name is invalid</li>";
              }

    if(isset($_POST['workplace'])){
        
            $workplace= test_input($_POST['workplace']);
            $messages[] = "<li>workplace is valid</li>";
        }else{
            $errors[] = "<li>workplace is invalid</li>";
        
    }
    if(isset($_POST['yexperience'])){
        
            $yexperience = test_input($_POST['yexperience']);
            $messages[] = "<li>Years of experience is valid</li>";
        }else{
            $errors[] = "<li>Years of experience is invalid</li>";
        
    }
    if(isset($_POST['responsibility'])){
        
        $responsibility= test_input($_POST['responsibility']);
        $messages[] = "<li>responsibilityis valid</li>";
    }else{
        $errors[] = "<li>Fresponsibility is invalid</li>";
...
if(isset($_POST['jtitle2']))
 {
    if(isset($_POST['employern2']))
    {
        if(isset($_POST['workplace2']))
        {
            if(isset($_POST['yexperience2']))
            {
                if(isset($_POST['responsibility2']))
                {
                    $jtitle2 = test_input($_POST['jtitle2']);
                    $employern2 = test_input($_POST['employern2']);
                    $workplace2 = test_input($_POST['workplace2']);
                    $yexperience2 = test_input($_POST['yexperience2']);
                    $responsibility2 = test_input($_POST['responsibility2']);
                    $query = "INSERT INTO `job`(email, jtitle, employern, workplace, yexperience, responsibility) 
                    VALUES ('$email', '$jtitle2', '$employern2', '$workplace2', '$yexperience2', '$responsibility2');";
                    $conn->query($query);
 ...
 {
    if(isset($_POST['employern3']))
    {
        if(isset($_POST['workplace3']))
        {
            if(isset($_POST['yexperience3']))
            {
                if(isset($_POST['responsibility3']))
                {
                    $jtitle3 = test_input($_POST['jtitle3']);
                    $employern3 = test_input($_POST['employern3']);
                    $workplace3 = test_input($_POST['workplace3']);
                    $yexperience3 = test_input($_POST['yexperience3']);
                    $responsibility3 = test_input($_POST['responsibility3']);
                    $query = "INSERT INTO `job`(email, jtitle, employern, workplace, yexperience, responsibility) 
                    VALUES ('$email', '$jtitle3', '$employern3', '$workplace3', '$yexperience3', '$responsibility3');";
                    $conn->query($query);
            ...
            <form id="form" name="form" method="POST">
                    <fieldset class="form-control">
                        ...
                        <div class="form-group">
                            <label for="jtitle" class="col-2 col-form-label">job title:<span style="color:red;"> *</span></label>
                            <input type="text" class="form-control" id="jtitle" name="jtitle">
                        </div>

                        <div class="form-group">
                            <label for="employern" class="col-2 col-form-label">employer name:<span style="color:red;"> *</span></label>
                            <input type="text" class="form-control" id="employern" name="employern">
                        </div>
                        <div class="form-group">
                            <label for="workplace" class="col-2 col-form-label">workplace:<span style="color:red;"> *</span></label>
                            <input type="text" class="form-control" id="workplace" name="workplace">
                        </div>
                        <div class="form-group">
                            <label for="yexperience" class="col-2 col-form-label">Years of experience:<span style="color:red;"> *</span></label>
                            <input type="text" class="form-control" id="yexperience" name="yexperience">
                        </div>
                        <div class="form-group">
                            <label for="responsibility" class="col-2 col-form-label">Responsibility:<span style="color:red;"> *</span></label>
