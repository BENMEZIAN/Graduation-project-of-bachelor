...
<html>
    <head>
        <meta charset="utf-8">
        <title>Admin profile - Users -</title>
        ...
        <main>
            <div class="container-fluid">
                <div class="row flex-nowrap">
                    ...
                    <div class="col py-3">
                        <h3 style="text-align:center; margin:10px;">Table of Users</h3>
                        <table class="table table-bordered" style="text-align:center;">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col">Age</th>
                                    <th scope="col">Sex</th>
                                    <th scope="col">Social situation</th>
                            ...
                            <tbody>
                                <?php
                                    ...
                                    while($row = $result->fetch_assoc()) {
                                        echo "<tr>";
                                        echo "<td>$row[applier_id]</td>";
                                        echo "<td>$row[lname]</td>";
                                        echo "<td>$row[fname]</td>";
                                        echo "<td>$row[birthday]</td>";
                                        echo "<td>$row[age]</td>";
                                        echo "<td>$row[sex]</td>";
                                        echo "<td>$row[social_situation]</td>";
