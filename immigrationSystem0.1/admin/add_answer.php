...
$conn = Dbconnect();
    ...
    if(isset($_POST['submit'])){
        ...
        $query = "INSERT INTO `answer` (`id_answer`, `content`) VALUES (null,'".$content."');";
...
<html>
    <head>
        <meta charset="utf-8">
        <title>Admin profile - Add Answer -</title>
                ...
                <div class="row flex-nowrap">
                    ...
                    <div class="col py-3">
                        <div class="container mb-6">
                            <h1 style="text-align: center; margin-top:2%;">Write your answer</h1>
                            <form id="form" name="form" method="POST">
                                <fieldset class="form-control">
                                    <div class="form-group">
                                        <label for="answer">Answer:<span style="color:red;"> *</span></label><br/><br/>
                                        <textarea class="form-control rounded-0" id="answer" name="answer" placeholder="write your answer" required rows="3"></textarea>
                                    </div><br/>
                                </fieldset><br/>
